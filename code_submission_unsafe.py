"""
Rate Limiter Implementation - UNSAFE VERSION
Contains some violations but implements core functionality
"""
...
class RateLimiter:
    def __init__(self, max_requests: int, time_window: int) -> None:
        ...
        # False: No thread safety - missing threading.Lock (requirement #11)
    
    def check_rate_limit(self, identifier: str) -> Tuple[bool, int]:
        """Check if request is allowed."""
        # False: Does not handle None/empty identifier (requirement #9)
        ...
        # True: Returns tuple (bool, int) (requirement #4)
        return (True, 0)
